...
class Online_rec:
    def __init__(self):
        ...
        self.n_classes = 5 # Number of positive classes
    ...
    def add_bbox(self, img):  
        img = img
        classes = ['background', 'remote', 'card', 'wallet', 'bottle', 'cup','chess']
        colors = [(250, 100, 20), (170, 250, 125), (0, 145, 250), (12, 250, 40), (240, 255, 2),(255,0,150)]
        for box in self.output:
            ...
            xmax = int(box[4]) * 2
            ymax = int(box[5]) * 2
            cv2.rectangle(img, (xmin, ymin), (xmax, ymax), colors[cls - 1], 2)
